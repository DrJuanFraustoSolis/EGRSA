...
c Copyright (C) 2020  Dr. Juan Paulo Sánchez Hernández, Fanny G. Maldonado Nava, 
...
c  Evolutionary Golden Ratio Simulated annealing (EGRSA)
c -The EGRSA has four fundamental parts: 1) The cooling scheme, 
c  2) The overheating strategies, 3) the perturbation process with genetic algorithm, 
c     and 4) The convergence criteria
c 
c -The firts version was developed by Dr. Juan Paulo Sánchez Hernández, Dra. Fanny G. Maldonado Nava 
c and Dr. Juan Frausto Solis
c  2017-2020
c***************************************************************


      subroutine  egrsa(g_energy)
...
c==========================
      write(*,*) 'EVOLUTIONARY GOLDEN RATIO SIMULATED ANNEALING'
	call cpu_time(start)
