...
contacts.o hbond.o helix.o egrsa.o metropolis.o rgyr.o zimmer.o \
...
partem_s.o esolan.o opesol.o evolutionary.o
...
opeflx.f opeshe.f minim.f minqsn.f contacts.f hbond.f helix.f egrsa.f90  rgyr.f \
...
mulcan_par_mod.f90 esolan.f opesol.f evolutionary.f
# partem_s.f


pyInterface=init_molecule init_energy mulcan_par mulcan_sim \
init_lund sgrnd energy helix zimmer rgyr rmsdfun \
egrsa canon  outpdb  minim  regul contacts interhbond hbond
# metropolis
# ============================================== Linking
...
regul.o eninteract.o bgs.o eyabgn.o enylun.o evolutionary.o\
